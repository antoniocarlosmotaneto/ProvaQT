...
<div class="form-container">
    <div class="logo-container">
        <img src="https://logodownload.org/wp-content/uploads/2016/11/corinthians-logo-0.png" alt="Corinthians Logo">
    </div>
    <?php
    if ($nivel_acesso == "Administrador") {
        ...
        echo '
            ...
            <form id="createForm" action="" method="post" onsubmit="return validarFormulario(event, \'createForm\')">
                ...
                <label for="nome">Confronto:</label>
            ...
            <form id="formEdit" action="" method="post" onsubmit="return validarFormulario(event, \'formEdit\')">
                ...
                <label for="nomeEdit">Confronto:</label>
                <input type="text" id="nomeEdit" name="nomeEdit">
                <label for="descricaoEdit">Local:</label>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p class='no-tasks'>Nenhuma partida encontrada</p>";
        }
